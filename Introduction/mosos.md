...
#### 2.3.5.1. Проверка разрешения имён
...
#### 2.3.5.2. Проверка состояния сервиса
```bash
...
3. Проверка прослушивания портов
...
#### 2.3.5.3. Проверка ответа веб-интерфейса (через curl)
...
#### 2.3.5.5. Проверка через веб-браузер
...
#### 2.3.5.8. Дополнительные полезные команды
```bash
